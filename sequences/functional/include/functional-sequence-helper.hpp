...
namespace math_helpers::sequences::functional {
    ...
    class FunctionalSequenceHelper: public virtual FunctionalSequence {
        ...
        const term_multiplier_t multiplier_;
        const int start_number;
        int count_iterations_;

    public:
        FunctionalSequenceHelper(const function1_t start_value_evaluator,const term_multiplier_t multiplier, const int &start_number = 0)
